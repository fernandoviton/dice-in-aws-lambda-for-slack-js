...
// given a result from parseForGeneralDiceRoll, return the text equvialent of it
...
// Parse for "c" with an optional "p" or "b" after
// This represents Cthulhu specific percentile checks with optional penalty or bonus 
exports.parseForCthulhu = function(text)
{
    var re = /^c( [p|b])?$/;
