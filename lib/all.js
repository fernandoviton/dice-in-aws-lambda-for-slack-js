...
exports.handler = function(event, context) {
    if (event.text)
    {
        ...
        var responseNewCharacter = doRollForNewCharacter(parseDiceTextForNewCharacter(event.text));
        if (responseNewCharacter !== null)
        {
            context.done(null, {"response_type": "in_channel", "text" : event.user_name + " " + responseNewCharacter, "mrkdwn": true});
            return;
        }
